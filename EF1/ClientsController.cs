...
namespace EF1
{
    ...
    {
        private readonly EF1Context _context;

        public ClientsController(EF1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Clients != null ? 
                          ...
                          Problem("Entity set 'EF1Context.Clients'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EF1Context.Clients'  is null.");
            }
            var clients = await _context.Clients.FindAsync(id);
            if (clients != null)
            {
